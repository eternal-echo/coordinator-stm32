...
#define AIOT_AT_DATA_RB_SIZE_DEFAULT		(500)		/* 内部网络数据接收缓冲区大小 */
#define AIOT_AT_RSP_RB_SIZE_DEFAULT			(500)		/* 内部应答报文接受缓冲区大小 */
#define AIOT_AT_CMD_RETRY_TIME				(3)			/* AT命令发送重试最大次数 */
#define AIOT_AT_RINGBUF_RETRY_INTERVAL		(1)		/* RINGBUF数据长度检查间隔时间 */
